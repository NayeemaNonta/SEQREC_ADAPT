#!/usr/bin/env python3
"""
adaptation/context_steering/multi_seed.py

Run the best context-gate config across N seeds for statistical significance testing.
Seed controls: DataLoader shuffle order, adapter weight initialisation.
(No negative sampling — uses full-vocab cross-entropy loss.)

Best config (from sweep): bottleneck_dim=8, lr=5e-4, epochs=10

Usage:
python adaptation/context_steering/multi_seed.py \
  ...
  --base_outdir results/multi_seed_context_gate_contiguous --device cuda
"""
